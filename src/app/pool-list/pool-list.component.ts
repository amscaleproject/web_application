...
export class PoolListComponent {
  ...
  helpContent: string = `    
    <div class="help-content">
        <div class="detail-overlay-header"><h2>Pool Help Guide</h2></div>
        <h3>Managing Pools</h3>
        ...
        <ol>
            ...
            <li>Similar CPU characteristics. AttikaMove will operate at the level of the least
        ...
        <p><span class="material-icons help-alert-info">info</span> Warning:
            ...
            between nodes.</p>
        <h3>Pools Dashboard</h3>
        <p>An overview of all Pools may be accessed by clicking "Pools" in the left navigation
            pane. It will open a dashboard reviewing "All Pools".</p><h4>All Pools</h4>
        <p>The dashboard for "All Pools" indicates:</p>
        <ul>
            <li>Pools: Number of Pools managed by this AttikaMove instance.</li>
        ...
        <p>The Pools list provides a multi-column sortable and searchable list of all configured
            Pools managed by AttikaMove. The search functionality allows an administrator to search for the name (or
            partial name) of any Pool.</p>
        <p>Sortable Columns include:</p>
        <ul>
        ...
        <p>For each of the Pools in the list, the administrator has the option to view the Pool
            Overview, Edit the Pool properties or Delete the Pool.</p><h4>Create Pool</h4>
        <p>Begin the process of creating a new Pool by clicking the "Create Pool" link.</p>
        <h3>Create a Pool</h3>
        <p>You will be asked to input the following information in Step 1:</p>
        <ol>
            <li>Name: User friendly name to describe the Pool being created. It must be a minimum
                of 5 characters.
            </li>
            <li>Description (Optional): Description of the Pool for internal reference.</li>
            <li>Node Type: aws [Amazon Web Service EC2 baremetal Instances] or baremetal
                [privately managed baremetal servers].
            </li>
        </ol>
        <p>Click "Save" to create the Pool. You will be taken back to the overview page for the
            newly created Pool.</p>
        <h3>Delete a Pool</h3>
        <p>Deleting a Pool will remove the Pool definition and all Nodes from AttikaMove
            management.</p>
        <p><span class="material-icons help-alert-info">info</span> Warning:
            Deleting a Pool is a destructive task. Once performed it may not be undone.</p>
        <p>In order to delete a Pool ensure all Nodes are unassigned.</p>
        <p><span class="material-icons help-more-info">info</span>
            Information: If any Nodes are assigned to a SDServer, the UI will not allow the Pool to be deleted.</p>
        <p>Once the above criteria has been met, click "Delete Pool". Click "Confirm" to delete
            the Pool.</p></div>      
    `;
